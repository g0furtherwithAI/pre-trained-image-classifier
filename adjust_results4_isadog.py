...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            if stripped_newline not in dognames_dic:
                dognames_dic[stripped_newline] = 1
                
            # Reads in next line in file to be processed with while loop
            # if this line isn't empty (EOF)
            #print(stripped_newline) - debugging print stmt
            line = infile.readline()
    print(dognames_dic)
    ...
    for key in results_dic:
        print("Key is: {}. Value is:{}".format(key, results_dic[key]))
    ...
    print("Inside Adjust results\n")

    for key in results_dic:
        print("\nFilename=", key, "\npet_image Label=", results_dic[key][0],
              "\nClassifier Label=", results_dic[key][1], "\nmatch=",
              results_dic[key][2], "\nLABEL is a Dog=", results_dic[key][3],
              "\nClassifier Label is a Dog=", results_dic[key][4])
